...
import { InternalNumber } from '@/lib/types';
...
function InternalNumbersContent() {
  const { nomor } = useAuth();
  ...
  async function load() {
    // Global -- tidak difilter per bot_source/nomor, memang sengaja satu daftar
    // dipakai bersama oleh kedua nomor bot.
    ...
    <div className="pl-56">
      ...
      <main className="mx-auto max-w-4xl px-4 py-6">
        ...
        <p className="mb-6 text-sm text-gray-500">
          Nomor kantor di sini dipisah dari kategori customer di chat log. Daftar ini berlaku global untuk kedua nomor bot (1052 &amp; 7484).
        </p>
...
export default function InternalNumbersPage() {
  return (
    <RequireAuth>
      <InternalNumbersContent />
    </RequireAuth>
  );
}
